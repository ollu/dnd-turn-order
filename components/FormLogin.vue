<template>
  <form @submit.prevent="userLogin" class="mt-10 flex w-full flex-col rounded-lg bg-gray-800 p-8 md:mt-0 md:w-1/2 lg:w-2/6">
    ...
    <a @click.prevent="$emit('switchToRegister')" class="w-fit text-sm text-white hover:text-blood cursor-pointer">Register</a>
  </form>
</template>
